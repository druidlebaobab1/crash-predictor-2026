...
const TRANSLATIONS = {
    fr: {
        ...
        alert_expired: "<strong>ABONNEMENT EXPIRÉ :</strong> renouvelez votre accès mensuel à 5 $.",
        btn_alert_unlock: "Débloquer l'accès – 5 $",
        btn_alert_renew: "Renouveler l'accès – 5 $",
        toast_expired: "Votre abonnement de 30 jours est expiré. Renouvelez à 5 $.",
        badge_edition: "SUITE MULTI-JEUX",
        nav_login: "Connexion",
        nav_register: "Inscription",
        promo_offer: "DERNIÈRE CHANCE 5 $ :",
        promo_remaining: "restante(s)",
        hero_subtitle: "UN SEUL ACCÈS À 5 $ PAR MOIS POUR DES MILLIERS DE PRÉDICTIONS",
        hero_subtitle_l1: "UN SEUL ACCÈS À <span class=\"hero-price-digits\">5 $</span> PAR MOIS",
        ...
        offer_desc: "Un seul accès à 5 $ / mois débloque les 6 moteurs de prédiction en temps réel.",
        price_lifetime: "/ Mois",
        price_cfa: "",
        ...
        btn_buy_instant: "DÉBLOQUER MON ACCÈS 5 $",
        ...
        btn_profile_unlock: "Débloquer mon accès complet – 5 $",
        ...
        btn_pay_card: "Payer par carte bancaire — 5 $",
    ...
    en: {
        ...
        alert_expired: "<strong>SUBSCRIPTION EXPIRED:</strong> renew your monthly access for $5.",
        btn_alert_unlock: "Unlock Access – $5",
        btn_alert_renew: "Renew Access – $5",
        toast_expired: "Your 30-day subscription has expired. Renew for $5.",
        badge_edition: "MULTI-GAME SUITE",
        nav_login: "Login",
        nav_register: "Sign Up",
        promo_offer: "LAST CHANCE $5:",
        promo_remaining: "remaining",
        hero_subtitle: "ONE ACCESS AT $5 PER MONTH FOR THOUSANDS OF PREDICTIONS",
        hero_subtitle_l1: "ONE ACCESS AT <span class=\"hero-price-digits\">$5</span> PER MONTH",
        ...
        btn_buy_instant: "UNLOCK MY ACCESS $5",
        ...
        btn_update: "Update",
        btn_profile_unlock: "Unlock Full Access – $5",
        btn_logout: "Logout",
        ...
        btn_pay_card: "Pay with Credit Card – $5",
    ...
    es: {
        ...
        alert_expired: "<strong>SUSCRIPCIÓN CADUCADA:</strong> renueve su acceso mensual por 5 $.",
        btn_alert_unlock: "Desbloquear Acceso – 5 $",
        btn_alert_renew: "Renovar acceso – 5 $",
        toast_expired: "Su suscripción de 30 días ha caducado. Renueve por 5 $.",
        badge_edition: "SUITE MULTI-JUEGOS",
        nav_login: "Iniciar Sesión",
        nav_register: "Registrarse",
        promo_offer: "ÚLTIMA OPORTUNIDAD 5 $:",
        promo_remaining: "restante(s)",
        hero_subtitle: "UN SOLO ACCESO A 5 $ AL MES PARA MILES DE PREDICCIONES",
        hero_subtitle_l1: "UN SOLO ACCESO A <span class=\"hero-price-digits\">5 $</span> AL MES",
        ...
        btn_buy_instant: "DESBLOQUEAR MI ACCESO 5 $",
        ...
        btn_profile_unlock: "Desbloquear acceso completo – 5 $",
        ...
        btn_pay_card: "Pagar con Tarjeta – 5 $",
    ...
    pt: {
        ...
        alert_expired: "<strong>ASSINATURA EXPIRADA:</strong> renove o seu acesso mensal por 5 $.",
        btn_alert_unlock: "Desbloquear Acesso – 5 $",
        btn_alert_renew: "Renovar acesso – 5 $",
        toast_expired: "A sua assinatura de 30 dias expirou. Renove por 5 $.",
        badge_edition: "SUITE MULTI-JOGOS",
        nav_login: "Entrar",
        nav_register: "Registar",
        promo_offer: "ÚLTIMA CHANCE 5 $:",
        promo_remaining: "restante(s)",
        hero_subtitle: "UM ÚNICO ACESSO A 5 $ POR MÊS PARA MILHARES DE PREVISÕES",
        hero_subtitle_l1: "UM ÚNICO ACESSO A <span class=\"hero-price-digits\">5 $</span> POR MÊS",
        ...
        btn_buy_instant: "DESBLOQUEAR MEU ACESSO 5 $",
        ...
        btn_profile_unlock: "Desbloquear Acesso – 5 $",
        ...
        btn_pay_card: "Pagar com Cartão – 5 $",
    ...
    de: {
        ...
        alert_expired: "<strong>ABO ABGELAUFEN:</strong> verlängern Sie Ihren monatlichen Zugang für 5 $.",
        btn_alert_unlock: "Zugang freischalten – 5 $",
        btn_alert_renew: "Zugang verlängern – 5 $",
        toast_expired: "Ihr 30-Tage-Abo ist abgelaufen. Verlängern Sie für 5 $.",
        badge_edition: "MULTI-GAME SUITE",
        nav_login: "Anmelden",
        nav_register: "Registrieren",
        promo_offer: "LETZTE CHANCE 5 $:",
        promo_remaining: "verbleibend",
        hero_subtitle: "EIN ZUGANG FÜR 5 $ PRO MONAT FÜR TAUSENDE VON TIPPS",
        hero_subtitle_l1: "EIN ZUGANG FÜR <span class=\"hero-price-digits\">5 $</span> PRO MONAT",
        ...
        btn_buy_instant: "MEINEN ZUGANG FREISCHALTEN 5 $",
        ...
        btn_profile_unlock: "Zugang freischalten – 5 $",
        btn_logout: "Abmelden",
        ...
        btn_pay_card: "Mit Kreditkarte bezahlen – 5 $",
...
function notifyExpiredAndInviteRenew(openCheckout) {
    ...
    showToast(i18nText("toast_expired", "Votre abonnement de 30 jours est expiré. Renouvelez à 5 $."), "error");
    if (openCheckout) document.getElementById("buyModal")?.classList.add("active");
}
...
function refreshSubscriptionAlertCopy() {
    ...
    if (alertText) {
        ...
        alertText.innerHTML = i18nText(key, expired
            ? "<strong>ABONNEMENT EXPIRÉ :</strong> renouvelez votre accès mensuel à 5 $."
    ...
    if (btnText) {
        ...
        btnText.textContent = i18nText(key, expired ? "Renouveler l'accès – 5 $" : "Débloquer l'accès – 5 $");
    }
}
