...
const TRANSLATIONS = {
    fr: {
        ...
        hero_subtitle: "UN SEUL ACCÈS À SEULEMENT 5 $ PAR MOIS",
    ...
    en: {
        ...
        hero_subtitle: "ONE ACCESS AT ONLY $5 PER MONTH",
    ...
    es: {
        ...
        promo_remaining: "restante(s)",
        hero_subtitle: "UN SOLO ACCESO A SOLO 5 $ AL MES",
    ...
    pt: {
        ...
        promo_remaining: "restante(s)",
        hero_subtitle: "UM ÚNICO ACESSO A APENAS 5 $ POR MÊS",
    ...
    de: {
        ...
        hero_subtitle: "EIN ZUGANG FÜR NUR 5 $ PRO MONAT",
